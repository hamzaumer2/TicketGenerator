...
with open('registrations.csv', newline='') as csvfile:
    reader = csv.DictReader(csvfile, fieldnames=['Team Name', 'Team Category', 'Member1', 'Contact1', 'Member2','Contact2', 'Member3', 'Contact3','Institution', 'Username', 'password'])
    ...
    for row in reader:
        ...
        draw.text((200, 140), f"Members:\n{member1}  - {cont1}\n{member2}  - {cont2}\n{member3}  - {cont3}", font=team_members_font, fill='black')

        draw.text((17, 230), f"In case of any query Contact", font=about_font, fill='black')
        draw.text((17, 243), f"Hamza Umer", font=about_font, fill='black')
        draw.text((17, 255), f"Think Tank Lead MLSA - AU", font=about_font, fill='black')
